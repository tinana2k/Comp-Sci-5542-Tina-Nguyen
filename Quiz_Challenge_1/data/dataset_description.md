...
Each row in the dataset is transformed into a text prompt. The dataset currently consists of 5 products, including 2 specifically designed for cross-product consistency testing.

### Example:

**Input (CSV row):**
`1, Women Summer Dress, apparel, red, cotton, casual`

**Baseline Prompt:**
`Women Summer Dress`

**Improved (Structured) Prompt:**
`Professional studio photography of a red cotton Women Summer Dress, casual aesthetic, centered composition, soft cinematic lighting, pure white solid background, 8k ultra-detailed, photorealistic, sharp focus, no shadows.`
